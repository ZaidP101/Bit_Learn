...
app.get("/php", (req, res) => {
  res.sendFile(path.join(__dirname, "../frontEnd/navBar/php/php.html")); // Ensure file exists
});

app.get("/cpp", (req, res) => {
  res.sendFile(path.join(__dirname, "../frontEnd/navBar/cpp/cpp.html")); // Ensure file exists
});

app.get("/java", (req, res) => {
  res.sendFile(path.join(__dirname, "../frontEnd/navBar/java/java.html")); // Ensure file exists
});

app.get("/dsa", (req, res) => {
  res.sendFile(path.join(__dirname, "../frontEnd/navBar/dsa/dsa.html")); // Ensure file exists
});
